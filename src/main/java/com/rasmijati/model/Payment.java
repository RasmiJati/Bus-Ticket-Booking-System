...
public class Payment implements IEntity {
    ...
    public Payment(Long id, Booking booking, String date, BigDecimal total_amount, BigDecimal paid_amount, BigDecimal due_amount) {
        this.id = id;
    ...
    public String toString() {
        return "id=" + id + ", booking=" + booking + ", date=" + date + ", Total amount= " + total_amount + " Paid amount= " + paid_amount + " Due amount=" + due_amount;
    }
}
